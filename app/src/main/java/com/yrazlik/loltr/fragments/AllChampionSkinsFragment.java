...
public class AllChampionSkinsFragment extends BaseFragment implements OnItemClickListener, TextWatcher{
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if (gridChampions == null || gridChampions.size() == 0 || allChampionsGridAdapter == null || allChampionsGridAdapter.getCount() == 0) {
            requestAllChampions();
        } else {
            setAdapter();
        }
